...
Public Class ManualPaymentDistributor
    ...
    Public Sub New(customerId As Integer, name As String, amount As Double, paymentMethod As String)
        InitializeComponent()
    ...
    Private Sub ManualPaymentDistributor_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        LabelCustomer.Text = "Customer: " & _customerName
    ...
    Private Sub LoadInvoices()
        Try
            ...
            ' Include timestamps to show the invoice date
            Dim sql As String = "SELECT timestamps, inv_no, amount FROM customer_credit WHERE customer_id = @cid AND amount > 0 AND is_active = 1 ORDER BY timestamps ASC"
            ...
            End If
            LabelTotalCredit.Text = "Total Outstanding: " & totalOutstanding.ToString("N2")
            ...
            ' Format Grid
            DataGridView1.Columns("timestamps").HeaderText = "Date"
            DataGridView1.Columns("timestamps").ReadOnly = True
            DataGridView1.Columns("timestamps").DefaultCellStyle.Format = "yyyy-MM-dd"
            DataGridView1.Columns("timestamps").Width = 120

            DataGridView1.Columns("inv_no").HeaderText = "Invoice No"
            DataGridView1.Columns("inv_no").ReadOnly = True
            DataGridView1.Columns("amount").HeaderText = "Credit Balance"
            ...
            ' Payment method is now passed from the main form via the constructor
    ...
    Private Sub RecalculateRemaining()
            ...
            If Not row.IsNewRow Then
                ...
                If val IsNot Nothing AndAlso Not IsDBNull(val) Then
                    ...
                    If Double.TryParse(val.ToString(), applied) Then
                        ' Validation: Cannot apply more than the credit balance for that invoice
        ...
        ElseIf _remainingAmount = 0 Then
            ...
            ' Optionally auto-complete if amount hits zero exactly
    ...
    Private Sub DataGridView1_CellClick(sender As Object, e As DataGridViewCellEventArgs) Handles DataGridView1.CellClick
        If e.RowIndex >= 0 Then
            ' Automatically jump to the "Amount to Pay" cell for the clicked row
    ...
    Private Sub DataGridView1_KeyDown(sender As Object, e As KeyEventArgs) Handles DataGridView1.KeyDown
        If e.KeyCode = Keys.Enter Then
            If DataGridView1.CurrentRow IsNot Nothing Then
                ...
                If DataGridView1.Columns.Contains("PayNow") Then
                    ' Move focus to the PayNow cell of the same row
