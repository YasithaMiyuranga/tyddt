...
Public Class PurchaseCashReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PE_System.PurchaseCashReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPurchaseCashReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PurchaseCashReport = New PurchaseCashReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
