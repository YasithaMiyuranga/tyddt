...
Public Class SaleReturnInv
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PE_System.SaleReturnInv.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSaleReturnInv
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SaleReturnInv = New SaleReturnInv()
        rpt.Site = Me.Site
        Return rpt
    End Function
