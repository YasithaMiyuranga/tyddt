...
Public Class fullcreditreport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PE_System.fullcreditreport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedfullcreditreport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As fullcreditreport = New fullcreditreport()
        rpt.Site = Me.Site
        Return rpt
    End Function
