...
Public Class fulldebitreport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PE_System.fulldebitreport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedfulldebitreport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As fulldebitreport = New fulldebitreport()
        rpt.Site = Me.Site
        Return rpt
    End Function
