...
Public Class supplierdebit
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PE_System.supplierdebit.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedsupplierdebit
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As supplierdebit = New supplierdebit()
        rpt.Site = Me.Site
        Return rpt
    End Function
