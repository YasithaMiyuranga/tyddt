...
Public Class MonthlyItemSales
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PE_System.MonthlyItemSales.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedMonthlyItemSales
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As MonthlyItemSales = New MonthlyItemSales()
        rpt.Site = Me.Site
        Return rpt
    End Function
