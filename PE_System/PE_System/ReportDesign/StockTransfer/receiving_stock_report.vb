...
Public Class receiving_stock_report
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "receiving_stock_report.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PE_System.receiving_stock_report.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_p_TransferID() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class Cachedreceiving_stock_report
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As receiving_stock_report = New receiving_stock_report()
        rpt.Site = Me.Site
        Return rpt
    End Function
